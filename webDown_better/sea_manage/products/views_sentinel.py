...
class MetaInfo(Resource):
    ...
    def get(self):
        ...
        list = []
        csv_ul = 'https://api-prod-private.asf.alaska.edu/services/search/param?output=CSV&product_list='
        ...
        for i in res['results']:
            ...
            csv_path = csv_ul + i['pid'].replace('{gn}', i['gn'])
    ...
    def get(self):
        ...
        if len(name) != 0:
            ...
            submit = driver.find_element_by_xpath(
                "//form[@id='login']/p[8]/input[@class='eui-btn--round eui-btn--green']")
            submit.click()
